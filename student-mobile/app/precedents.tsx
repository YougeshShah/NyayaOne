    ...
    <View style={styles.container}>
      ...
      {results && results.pagination.totalPages > 1 && (
        <View style={styles.pageBar}>
          ...
          >
            <Ionicons name="chevron-back" size={18} color={page <= 1 ? "#D1D5DB" : "#2563EB"} />
          </TouchableOpacity>
          ...
          >
            <Ionicons name="chevron-forward" size={18} color={page >= results.pagination.totalPages ? "#D1D5DB" : "#2563EB"} />
          </TouchableOpacity>
        </View>
      )}
...
const styles = StyleSheet.create({
  ...
  pageText: { fontSize: 13, fontWeight: "600", color: "#111827" },
