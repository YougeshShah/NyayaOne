      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Text style={styles.emptyText}>
            Ask me anything about your studies, courses, or how to use the app. For case-specific legal advice, please contact your teacher or institution.
          </Text>
        }
        renderItem={({ item }) => (
          <View style={[styles.messageRow, item.role === "user" && styles.messageRowUser]}>
            <Ionicons name={item.role === "assistant" ? "chatbubble-ellipses" : "person-circle-outline"} size={20} color={item.role === "assistant" ? "#2563EB" : "#6B7280"} />
...
const styles = StyleSheet.create({
  ...
  sendButton: { backgroundColor: "#2563EB", width: 40, height: 40, borderRadius: 20, alignItems: "center", justifyContent: "center" },
});
