...
-- CreateIndex
CREATE INDEX "SupportTicket_lawFirmId_idx" ON "SupportTicket"("lawFirmId");
...
-- AddForeignKey
ALTER TABLE "SupportTicket" ADD CONSTRAINT "SupportTicket_lawFirmId_fkey" FOREIGN KEY ("lawFirmId") REFERENCES "LawFirm"("id") ON DELETE CASCADE ON UPDATE CASCADE;
